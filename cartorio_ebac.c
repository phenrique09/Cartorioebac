...
int main() //funçao
{
	...
	printf("Login De Administrador\n\n Digite a sua senha:"); //Login de Administrador
	scanf("%s", senhadigitada);  //salva dentro de uma string
	
	comparacao = strcmp(senhadigitada, "admin"); //comparando se a senha é admin
	
	if (comparacao == 0) //se a senha for admin
	{
		system("cls"); //pausa a tela
